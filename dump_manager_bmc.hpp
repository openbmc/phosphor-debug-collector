...
#include "dump_manager_bmc_stored.hpp"
 ...
 */
class Manager : public CreateIface, public phosphor::dump::BMC_stored::Manager
{
  ...
  public:
    ...
    Manager(sdbusplus::bus::bus& bus, const EventPtr& event, const char* path) :
        ...
        phosphor::dump::BMC_stored::Manager(bus, event, path, BMC_DUMP_PATH)
    {
    }
