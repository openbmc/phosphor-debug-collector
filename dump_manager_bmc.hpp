...
class Manager : public CreateIface, public phosphor::dump::local::Manager
{
  ...
  public:
     ...
     */
    Manager(sdbusplus::bus::bus& bus, const EventPtr& event, const char* path, const std::string& baseEntryPath, const char* filePath) :
        CreateIface(bus, path),
        phosphor::dump::local::Manager(bus, event, path, baseEntryPath,  filePath)
    {
    }
