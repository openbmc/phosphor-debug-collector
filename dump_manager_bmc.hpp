...
/** @class Manager
 *  @brief Local Dump  manager implementation.
 *  @details Implements the common functions
 *  and properties for the dumps stored locally
 */
  ...
  public:
    ...
    Manager(sdbusplus::bus::bus& bus, const EventPtr& event, const char* path,
        ...
        dumpWatch(eventLoop, IN_NONBLOCK, IN_CLOSE_WRITE | IN_CREATE, EPOLLIN,
                  filePath,
                  std::bind(std::mem_fn(
                                &phosphor::dump::bmc::Manager::watchCallback),
