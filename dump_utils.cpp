...
BootProgress getBootProgress()
{
    ...
    std::string value = getStateValue<BootProgress>(
        bootProgressInterface, hostStateObjPath, "BootProgress");
...
HostState getHostState()
{
    ...
    // TODO Need to change host instance if multiple instead "0"
    constexpr auto hostStateObjPath = "/xyz/openbmc_project/state/host0";
    std::string value = getStateValue<HostState>(
        hostStateInterface, hostStateObjPath, "CurrentHostState");
