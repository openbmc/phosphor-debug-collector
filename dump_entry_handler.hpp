...
{
  public:
    DumpEntryFileHelper() = delete;
    DumpEntryFileHelper(const DumpEntryFileHelper&) = delete;
    DumpEntryFileHelper& operator=(const DumpEntryFileHelper&) = delete;
    DumpEntryFileHelper(DumpEntryFileHelper&&) = delete;
    DumpEntryFileHelper& operator=(DumpEntryFileHelper&&) = delete;
    ~DumpEntryFileHelper() = default;
     ...
     */
    DumpEntryFileHelper(BaseEntry& dumpEntry,
