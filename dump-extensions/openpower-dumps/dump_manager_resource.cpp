...
void Manager::notify(uint32_t dumpId, uint64_t size)
{
    ...
    for (auto& entry : entries)
    {
        ...
        {
            lg2::info(
                "Resource dump entry with source dump id: {DUMP_ID} is already present with entry id: {ENTRY_ID}",
    ...
    {
        lg2::info(
            "Resource Dump Notify: Updating dumpId: {DUMP_ID} with source Id: {SOURCE_ID} Size: {SIZE}",
    ...
    {
        lg2::info(
            "Resouce Dump Notify: creating new dump entry dumpId: {DUMP_ID} Id: {ID} Size: {SIZE}",
    ...
    {
        lg2::error(
            "Error in creating resource dump entry, errormsg: {ERROR_MSG}, OBJECTPATH: {OBJECT_PATH}, ID: {ID}, TIMESTAMP: {TIMESTAMP}, SIZE: {SIZE}, SOURCEID: {SOURCE_ID}",
    ...
    Manager::createDump(phosphor::dump::DumpCreateParams params)
{
    ...
    {
        lg2::error(
            "Error in creating resource dump entry, errormsg: {ERROR_MSG}, OBJECTPATH: {OBJECT_PATH}, VSPSTRING: {VSP_STRING}, ID: {ID}",
