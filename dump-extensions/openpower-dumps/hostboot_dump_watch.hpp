...
class Manager : public phosphor::dump::filewatch::Manager
{
  public:
     ...
     */
    Manager(const phosphor::dump::EventPtr& event) :
        phosphor::dump::filewatch::Manager(
            event, HOSTBOOT_DUMP_FILE_DIR,
            "xyz.openbmc_project.Dump.Internal.Create.Type.Bootfailure")
    {
    }
  ...
  private:
     ...
     */
    void watchCallback(const phosphor::dump::filewatch::UserMap& fileInfo);
};
