    ...
    virtual public phosphor::dump::Manager
{
  ...
  private:
    ...
    /** @brief Create crashdump fault log entry based on the message received
     * in the D-Bus signal indicating a new crashdump is available
     *  @param[in] msg - The message from the D-Bus signal
     */
    void createDumpFromCrashdumpSignal(sdbusplus::message_t& msg);
