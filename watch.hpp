...
//User specfic call back function input map type.
using UserMap = std::map<fs::path, uint32_t>;

//User specific callback function wrapper type.
using UserType = std::function<void(UserMap&)>;
...
class Watch
{
    ...
    private:
         ...
         *  @details Collectes the files and event info and call the
         *            appropriate user functions for further action.
         *
