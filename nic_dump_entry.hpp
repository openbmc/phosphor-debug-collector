...
#include "xyz/openbmc_project/Dump/Entry/NIC/server.hpp"
...
using EntryIfaces = sdbusplus::server::object_t<
    sdbusplus::xyz::openbmc_project::Dump::Entry::server::NIC>;
...
class Entry : virtual public phosphor::dump::Entry, virtual public EntryIfaces
{
  public:
        ...
        EntryIfaces(bus, objPath.c_str(), EntryIfaces::action::defer_emit)
    {
        ...
        this->phosphor::dump::nic::EntryIfaces::emit_object_added();
    }
