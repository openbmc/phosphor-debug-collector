...
class Entry : public EntryIfaces
{
  public:
     ...
     *  @param[in] originator_id - Id of the originator of the dump
     *  @param[in] originator_type - Originator type
     *  @param[in] parent - The dump entry's parent.
     */
    Entry(sdbusplus::bus_t& bus, const std::string& objPath, uint32_t dumpId,
          uint64_t timeStamp, uint64_t dumpSize, OperationStatus dumpStatus,
          std::string originator_id, originatorTypes originator_type,
          Manager& parent) :
