...
class Entry : virtual public EntryIfaces, virtual public phosphor::dump::Entry
{
  public:
     ...
     *  is completed this will be function used to update the entry which got
    ...
    void update(uint64_t timeStamp, uint64_t fileSize, const fs::path& filePath)
    {
        elapsed(timeStamp);
        size(fileSize);
        // TODO: Handled dump failed case with #2808
        status(OperationStatus::Completed);
        file = filePath;
        // TODO: serialization of this property will be handled with #2597
